...
custom_paths+=( ["/var/ossec/data/"]=/backup/ossec_backup/ )
custom_paths+=( ["/etc/filebeat/"]=/backup/filebeat_backup/ )
custom_paths+=( ["/var/lib/filebeat/"]=/backup/filebeat-lib_backup/ )
custom_paths+=( ["/etc/postfix/"]=/backup/postfix_backup/ )
